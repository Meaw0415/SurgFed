...
from sam2_train.modeling.sam.mask_dep_decoder import MaskDecoder
...
class SAM2Base_depth(torch.nn.Module):
    def __init__(
        self,
        image_encoder,
        memory_attention,
    ...
    def _forward_sam_heads(
        ...
        if self.client_idx != -1:
            ...
            # Ablation study: Directly use CLIP as site embedding
            # print(site_embedding.shape) # 1,512,32,32
            # print(backbone_features.shape) # 1,256,32,32
            # site_embedding = site_embedding.view(1, 256, 2, 32, 32).mean(dim=2)  # 对通道分组后取平均
            # backbone_features = backbone_features + site_embedding
            ...
            backbone_features = gating * backbone_features + backbone_features
    ...
    def _use_mask_as_output(self, backbone_features, high_res_features, mask_inputs):
        ...
        if not self.use_obj_ptrs_in_encoder:
            ...
            _, _, _, _, _, obj_ptr, _ , depth_maps = self._forward_sam_heads(
    ...
    def track_step(
        ...
        current_out["depth_maps"] = depth_maps
